...
class Event extends Component {
  ...
  render() {  
    ...
    return (<li key={event.id} className="artist-event" data-test="artist-event">
        <span className="event-date" data-test="event-date">
            <span className="event-month" data-test="event-month">{this.state.months[eventDate.getMonth()]}</span>
            <span className="event-day" data-test="event-day">{eventDate.getDate()}</span>
        </span>
